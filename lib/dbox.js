        ...
        account: function(cb){
          ...
          return request(args, function(e, r, b){
            if( e ){
              ...
              var json = helpers.parseJSON(b);
              helpers.timeCorrection(r,json);
        ...
        delta: function(args, cb){
          ...
          var fetch = function(args){
            ...
            return request(opts, function(e, r, b){
              ...
              helpers.timeCorrection(r, output);
        ...
        get: function(path, args, cb){
          ...
          return request(args, function(e, r, b) {
            if (e) {
              ...
              var headers = {};
              if(r.headers['x-dropbox-metadata'] !== undefined){
                headers = helpers.parseJSON(r.headers['x-dropbox-metadata']);
                helpers.timeCorrection(r,headers);
              }
        ...
        metadata: function(path, args, cb){
          ...
          return request(args, function(e, r, b){
            ...
            if( e ){
              ...
              var json = r.statusCode == 304 ? {} : helpers.parseJSON(b);
              helpers.timeCorrection(r, json);
              cb(r.statusCode, json);
            }
          })
